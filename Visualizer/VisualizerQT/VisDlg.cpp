...
#include "VisualizerCommon/VisualizerDefines.h"
...
VisDlg::VisDlg(QWidget *parent) : QMainWindow(parent), ui(new VisualizerDlg)
{
    ...
    trayIcon->setToolTip("Visualizer");
...
void VisDlg::SetVisualizer(Visualizer* v)
{
    vis_ptr = v;
...
void VisDlg::StartMinimized(boolean startmin)
{
    startminimized = startmin;
}

void VisDlg::on_lineEdit_Amplitude_textChanged(const QString &arg1)
{
    vis_ptr->amplitude = arg1.toInt();
    vis_ptr->OnSettingsChanged();
}

void VisDlg::on_lineEdit_Background_Brightness_textChanged(const QString &arg1)
{
    vis_ptr->bkgd_bright = arg1.toInt();
    vis_ptr->OnSettingsChanged();
}

void Ui::VisDlg::on_lineEdit_Average_Size_textChanged(const QString &arg1)
{
    vis_ptr->avg_size = arg1.toInt();
    vis_ptr->OnSettingsChanged();
}

void Ui::VisDlg::on_lineEdit_Decay_textChanged(const QString &arg1)
{
    vis_ptr->decay = arg1.toInt();
    vis_ptr->OnSettingsChanged();
}

void Ui::VisDlg::on_lineEdit_Delay_textChanged(const QString &arg1)
{
    vis_ptr->delay = arg1.toInt();
    vis_ptr->OnSettingsChanged();
}

void Ui::VisDlg::on_lineEdit_Normalization_Offset_textChanged(const QString &arg1)
{
...
void Ui::VisDlg::on_lineEdit_Normalization_Scale_textChanged(const QString &arg1)
{
...
void Ui::VisDlg::on_lineEdit_Animation_Speed_textChanged(const QString &arg1)
{
    vis_ptr->anim_speed = arg1.toFloat();
    vis_ptr->OnSettingsChanged();
}

void Ui::VisDlg::on_comboBox_FFT_Window_Mode_currentIndexChanged(int index)
{
    vis_ptr->window_mode = index;
    vis_ptr->OnSettingsChanged();
}

void Ui::VisDlg::on_comboBox_Background_Mode_currentIndexChanged(int index)
{
    vis_ptr->bkgd_mode = index;
    vis_ptr->OnSettingsChanged();
}

void Ui::VisDlg::on_comboBox_Foreground_Mode_currentIndexChanged(int index)
{
    vis_ptr->frgd_mode = index;
    vis_ptr->OnSettingsChanged();
}

void Ui::VisDlg::on_comboBox_Single_Color_Mode_currentIndexChanged(int index)
{
    vis_ptr->single_color_mode = index;
    vis_ptr->OnSettingsChanged();
}

void Ui::VisDlg::on_comboBox_Average_Mode_currentIndexChanged(int index)
{
    vis_ptr->avg_mode = index;
    vis_ptr->OnSettingsChanged();
}

void Ui::VisDlg::on_pushButton_Save_Settings_clicked()
{
    vis_ptr->SaveSettings();
}

void Ui::VisDlg::on_checkBox_Reactive_Background_clicked(bool checked)
{
...
void Ui::VisDlg::on_comboBox_Audio_Device_currentIndexChanged(int index)
{
...
void Ui::VisDlg::on_lineEdit_Filter_Constant_textChanged(const QString &arg1)
{
...
void Ui::VisDlg::on_checkBox_Silent_Background_clicked(bool checked)
{
...
void Ui::VisDlg::on_lineEdit_Background_Timeout_textChanged(const QString &arg1)
{
