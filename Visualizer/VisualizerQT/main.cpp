...
#include "VisualizerCommon/LEDStrip.h"
...
void parse_argument_string(char * argument, char * value)
{
    ...
    if(argument)
    {
        ...
        {
            vis.nrml_ofst = strtod(value, nullptr);
        }
        else if (strcmp(argument, "nrml_scl") == 0)
        {
            vis.nrml_scl = strtod(value, nullptr);
        }
        else if (strcmp(argument, "fltr_const") == 0)
        {
            vis.filter_constant = strtod(value, nullptr);
        ...
        {
            vis.anim_speed = strtod(value, nullptr);
        }
